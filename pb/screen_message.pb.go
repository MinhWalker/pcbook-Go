...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=minhdt.pcbook.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x0b, 0x32, 0x20, 0x2e, 0x6d, 0x69, 0x6e, 0x68, 0x64, 0x74, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f,
	...
	0x2e, 0x6d, 0x69, 0x6e, 0x68, 0x64, 0x74, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x53,
	...
	0x04, 0x4f, 0x4c, 0x45, 0x44, 0x10, 0x02, 0x42, 0x24, 0x0a, 0x1b, 0x63, 0x6f, 0x6d, 0x2e, 0x67,
	0x69, 0x74, 0x6c, 0x61, 0x62, 0x2e, 0x6d, 0x69, 0x6e, 0x68, 0x64, 0x74, 0x2e, 0x70, 0x63, 0x62,
	0x6f, 0x6f, 0x6b, 0x2e, 0x70, 0x62, 0x50, 0x01, 0x5a, 0x03, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: minhdt.pcbook.Screen.Panel
	(*Screen)(nil),            // 1: minhdt.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: minhdt.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: minhdt.pcbook.Screen.resolution:type_name -> minhdt.pcbook.Screen.Resolution
	0, // 1: minhdt.pcbook.Screen.panel:type_name -> minhdt.pcbook.Screen.Panel
